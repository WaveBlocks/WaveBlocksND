...
class HagedornWavepacket(HagedornWavepacketBase):
    ...
    def __str__(self):
        """:return: A string describing the Hagedorn wavepacket :math:`\Psi`.
        """
    ...
    def evaluate_basis_at(self, grid, component=None, prefactor=False):
    ...
    def evaluate_at(self, grid, component=None, prefactor=False):
        """Evaluate the Hagedorn wavepacket :math:`\Psi` at the given nodes :math:`\gamma`.
