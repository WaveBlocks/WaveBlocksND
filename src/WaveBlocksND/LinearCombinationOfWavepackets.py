...
class LinearCombinationOfWavepackets(object):
    ...
    def __str__(self):
        r""":return: A string describing the linear combination of wavepackets.
    ...
    def get_dimension(self):
        r""":return: The space dimension :math:`D` of all the wavepackets :math:`\Psi_j`.
        """
        return self._dimension


    def get_number_components(self):
        r""":return: The number :math:`N` of components all the wavepackets :math:`\Psi_j` have.
        """
        return self._number_components


    def get_number_packets(self):
        r""":return: The number :math:`J` of wavepackets in the linear
        combination :math:`\Upsilon := \sum_{j=0}^{J-1} c_j \Psi_j`.
        """
