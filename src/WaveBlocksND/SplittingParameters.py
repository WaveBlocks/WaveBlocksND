...
class SplittingParameters(object):
    ...
    def build(self, method):
        ...
        if method == "LT":
            ...
            a = zeros(s)
            b = zeros(s)
            a[0]  =  0.09040619368607278492161150
            a[1]  =  0.53591815953030120213784983
            a[2]  =  0.35123257547493978187517736
            a[3]  = -0.31116802097815835426086544
            a[4]  = -0.52556314194263510431065549
            a[5]  =  0.14447909410225247647345695
            a[6]  =  0.02983588609748235818064083
            a[7]  =  0.17786179923739805133592238
            a[8]  =  0.09826906939341637652532377
            a[9]  =  0.46179986210411860873242126
            a[10] = -0.33377845599881851314531820
            a[11] =  0.07095684836524793621031152
            a[12] =  0.23666960070126868771909819
            a[13] = -0.49725977950660985445028388
            a[14] = -0.30399616617237257346546356
            a[15] =  0.05246957188100069574521612
            a[16] =  0.44373380805019087955111365
            a[17:] = flipud(a[:16])
            b[0:-1] = 0.5 * (a[:-1] + a[1:])
            b[-1] = 1.0 * b[0]
        else:
