...
if __name__ == "__main__":
    ...
    for blockid in iom.get_block_ids():
        ...
        if iom.has_inhomogwavepacket(blockid=blockid):
            ...
            AutocorrelationWavepacket.compute_autocorrelation_inhawp(iom, blockid=blockid)
        # We test for a homogeneous wavepacket next
        elif iom.has_wavepacket(blockid=blockid):
            import AutocorrelationWavepacket
            AutocorrelationWavepacket.compute_autocorrelation_hawp(iom, blockid=blockid)
        # We have no wavepacket, then we try for a wavefunction
            ...
            AutocorrelationWavefunction.compute_autocorrelation(iom, blockid=blockid)
